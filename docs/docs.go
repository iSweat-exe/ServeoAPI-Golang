...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v2/docker/containers/{id}/rename": {
            "patch": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/docker.RenameContainerRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/firewall.AddRuleRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/firewall.StatusResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/v2/ovh/dedicated/server/{serviceName}/reboot": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Server Service Name (e.g. ns300000.ip-1-2-3.eu)",
                        "name": "serviceName",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/permissions.Group"
                            }
                        }
                    }
                }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users.AdminUpdatePasswordRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "firewall.AddRuleRequest": {
            "type": "object",
            "properties": {
                "action": {
                    "description": "Action: \"allow\", \"deny\", \"reject\" ou \"limit\".",
                    "type": "string"
                },
                "comment": {
                    "type": "string"
                ...
                "from": {
                    "description": "From: IP ou CIDR autorisé/visé, \"any\" par défaut.",
                    "type": "string"
                },
                "port": {
                    "description": "Port: un port (\"8080\") ou une plage (\"8000:9000\").",
                    "type": "string"
                },
                "protocol": {
                    "description": "Protocol: \"tcp\", \"udp\", ou vide pour les deux.",
                    "type": "string"
                }
            }
        },
        ...
        "permissions.Group": {
            ...
            "properties": {
                ...
                "scopes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/permissions.Scope"
                    }
                }
            }
        },
        ...
        "users.AdminUpdatePasswordRequest": {
            "type": "object",
            "required": [
                "new_password"
            ],
